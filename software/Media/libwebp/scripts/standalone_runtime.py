#!/usr/bin/env python3
"""Provide self-contained environment collection and reporting for libwebp."""
...
def record_build_info(
    ...
    if not actual_version:
        raise RuntimeError("actual libwebp version is empty")
...
def extract_metrics(
    ...
    if aggregate.get("software") != "libwebp":
...
def render_report(result: dict[str, Any]) -> str:
    lines = [
        f"# libwebp {result['version']} 独立性能测试报告",
        "",
