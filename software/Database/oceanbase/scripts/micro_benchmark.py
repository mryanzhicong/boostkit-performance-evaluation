...
from benchmark_ob import check_observer, create_database, sysbench_prepare, sysbench_run, resolve_arch
...
def main():
    ...
    out = {
        ...
        "description": f"OceanBase micro: thread scaling + table count sweep on {arch}",
