#!/usr/bin/env python3
"""Provide self-contained environment collection and reporting for Tomcat."""
...
def record_build_info(
    ...
    if not actual_version:
        raise RuntimeError("actual Tomcat version is empty")
...
def extract_metrics(
    ...
    if aggregate.get("software") != "tomcat":
...
def render_report(result: dict[str, Any]) -> str:
    lines = [
        f"# Tomcat {result['version']} 独立性能测试报告",
        "",
