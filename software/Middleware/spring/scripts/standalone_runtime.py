#!/usr/bin/env python3
"""Provide self-contained environment collection and reporting for Spring."""
...
def record_build_info(
    ...
    if not actual_version:
        raise RuntimeError("actual Spring Framework version is empty")
...
def extract_metrics(
    ...
    if aggregate.get("software") != "spring":
...
def render_report(result: dict[str, Any]) -> str:
    lines = [
        f"# Spring Framework {result['version']} 独立性能测试报告",
        "",
