#!/usr/bin/env python3
"""Provide self-contained environment collection and reporting for gRPC-Java."""
...
def record_build_info(
    ...
    if not actual_version:
        raise RuntimeError("actual gRPC-Java version is empty")
...
def extract_metrics(
    ...
    if aggregate.get("software") != "grpc-java":
...
def render_report(result: dict[str, Any]) -> str:
    lines = [
        f"# gRPC-Java {result['version']} 独立性能测试报告",
        "",
