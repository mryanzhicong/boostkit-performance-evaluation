#!/usr/bin/env python3
"""Provide self-contained environment collection and reporting for Netty."""
...
def record_build_info(
    ...
    if not actual_version:
        raise RuntimeError("actual Netty version is empty")
...
def extract_metrics(
    ...
    if aggregate.get("software") != "netty":
...
def render_report(result: dict[str, Any]) -> str:
    lines = [
        f"# Netty {result['version']} 独立性能测试报告",
        "",
