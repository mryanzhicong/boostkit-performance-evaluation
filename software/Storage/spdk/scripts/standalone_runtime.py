#!/usr/bin/env python3
"""Provide self-contained environment collection and reporting for spdk."""
...
def record_build_info(
    ...
    if not actual_version:
        raise RuntimeError("actual spdk version is empty")
...
def extract_metrics(
    ...
    if aggregate.get("software") != "spdk":
...
def render_report(result: dict[str, Any]) -> str:
    lines = [
        f"# spdk {result['version']} 独立性能测试报告",
        "",
