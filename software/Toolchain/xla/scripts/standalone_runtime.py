#!/usr/bin/env python3
"""Provide self-contained environment collection and reporting for XLA."""
...
def record_build_info(
    ...
    if not actual_version:
        raise RuntimeError("actual XLA version is empty")
