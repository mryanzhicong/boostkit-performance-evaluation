#!/usr/bin/env python3
"""Provide self-contained environment collection and reporting for Clang."""
...
def record_build_info(
    ...
    if not actual_version:
        raise RuntimeError("actual Clang version is empty")
...
def extract_metrics(
    ...
    if aggregate.get("software") != "clang":
...
def render_report(result: dict[str, Any]) -> str:
    lines = [
        f"# Clang {result['version']} 独立性能测试报告",
        "",
